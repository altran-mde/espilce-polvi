...
public class XtextDelegateFileSystemAccess implements org.espilce.polvi.emf.generator.api.fsa.IFileSystemAccess2 {
	...
	public void generateFile(final String fileName, final String outputCfgName, final InputStream content)
		...
		} catch (final org.espilce.polvi.generator.api.fsa.RuntimeIOException e) {
